...
Edad edad = new Edad(puntos, generos, nse);
String mapa = edad.getMapa();

ResultSet rs = edad.getEdades();

Counter counts = edad.getCount();
...
String detalleQuery = edad.getQueryDetalle();

String title = "Menú Edad";
...
function toggle(source) {
	if(document.getElementById("all").checked == 1){
	  ...
	  checkboxes = document.getElementsByName('edad');
          ...
          <div id="select" class="col-md-4">
            ...
            <div id="seleccionSub">
                ...
                <div class="checkbox checkbox-success">
                    <input id ="checkboxG<%=i%>"data-toggle="checkbox"  type="checkbox" name="edad" onclick="enableSubmit()" value="<%= rs.getString(1)%>">
