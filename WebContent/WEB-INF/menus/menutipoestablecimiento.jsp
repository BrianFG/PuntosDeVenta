...
<%@ page import="estados.TipoEstablecimiento" %>
...
TipoEstablecimiento tipo = new TipoEstablecimiento(subzonas);
String mapa = tipo.getMapa();
Counter counts = tipo.getCount();
...
String detalleQuery = tipo.getQueryDetalle();

ResultSet rs= tipo.getTiposEstablecimiento();

String title = "Menú Tipo Establecimiento";
String accion = "MenuCategoria";

String checkbox = "tipo";
          ...
          <div id="select" class="col-md-4">
            ...
            <div id="seleccionSub">
                ...
                <div class="checkbox checkbox-success">
                    <input id ="checkboxG<%=i%>"data-toggle="checkbox"  type="checkbox" name="tipo" onclick="enableSubmit()" value="<%= rs.getString(1)%>">
