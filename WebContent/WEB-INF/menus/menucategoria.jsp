...
Categoria categoria = new Categoria(subzonas, tipos);
String mapa = categoria.getMapa();
Counter counts = categoria.getCount();
...
String detalleQuery = categoria.getQueryDetalle();

ResultSet rs= categoria.getCategorias();

String title = "Menú Categoría";
String accion = "MenuCadena";

String checkbox = "categoria";
          ...
          <div id="select" class="col-md-4">
            ...
            <div id="seleccionSub">
                ...
                <div class="checkbox checkbox-success">
                    <input id ="checkboxG<%=i%>"data-toggle="checkbox"  type="checkbox" name="categoria" onclick="enableSubmit()" value="<%= rs.getString(1)%>">
