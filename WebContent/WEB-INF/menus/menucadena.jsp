...
Cadena cadena = new Cadena(subzonas, tipos, categorias);
ResultSet rs= cadena.getCadenas();
String mapa = cadena.getMapa();
Counter counts = cadena.getCount();
...
String detalleQuery = cadena.getQueryDetalle();


String title = "Menú Cadena";
String accion = "MenuGenero";

String checkbox = "cadena";
...
<%=mapa %>
	...
	function toggle(source) {
		if(document.getElementById("all").checked == 1){
		  ...
		  checkboxes = document.getElementsByName('cadena');
          ...
          <div id="select" class="col-md-4">
            ...
            <div id="seleccionSub">
                ...
                <div class="checkbox checkbox-success">
                    <input id ="checkboxG<%=i%>"data-toggle="checkbox"  type="checkbox" name="cadena" onclick="enableSubmit()" value="<%= rs.getString(1)%>">
