...
NSE nse = new NSE(puntos, generos);
String mapa = nse.getMapa();
ResultSet rs = nse.getNSE();

Counter counts = nse.getCount();
...
String detalleQuery = nse.getQueryDetalle();

String title = "Menú Nivel Socio Económico";
String accion = "MenuEdad";
...
function toggle(source) {
	if(document.getElementById("all").checked == 1){
	  ...
	  checkboxes = document.getElementsByName('nse');
          ...
          <div id="select" class="col-md-4">
            ...
            <div id="seleccionSub">
                ...
                <div class="checkbox checkbox-success">
                    <input id ="checkboxG<%=i%>"data-toggle="checkbox"  type="checkbox" name="nse" onclick="enableSubmit()" value="<%= rs.getString(1)%>">
