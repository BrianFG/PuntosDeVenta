...
<%@page import="estados.DespligueFinal"%>
...
DespligueFinal dFinal = new DespligueFinal(puntos, generos, nse , edades);

ResultSet rs = dFinal.getPuntos();
ResultSet punMapa = dFinal.getPuntos();
String mapa = dFinal.getMapScript();


ResultSet puntosC = dFinal.getPuntos();

Counter counts = dFinal.getCount();
...
String detalleQuery = dFinal.getQueryDetalle();

String title = "Despliegue Final";
String accion = "Top";
