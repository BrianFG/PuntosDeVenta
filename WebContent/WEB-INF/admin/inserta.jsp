...
String query = "insert into Usuarios select max(idUsuario)+1 " 
     + ", '" + usuario + "' , '" + nombre + "', '" + apellidos 
     + "', " + rol + ", '" + correo + "' , " + telefono + ", " + " AES_ENCRYPT('" + password + "', 'Mexico01') " + " , " + activo + " from Usuarios";

String query2 = "insert into Login " 
+ "select max(idUsuario), max(idUsuario) , 0 from Usuarios";

if (QueryMaker.executeUpdate(query) & QueryMaker.executeUpdate(query2)){
	mensaje = "Inserción existosa";
}
