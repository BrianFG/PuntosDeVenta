...
public class Cadena {
	...
	public Cadena(String[] subzonas, String[] tipos, String[] categorias) {
		this.subzonas = subzonas;
		this.tipos = tipos;
		this.categorias = categorias;
	}

	public ResultSet getCadenas( ){
	...
	public String generateQuery ( ){
		...
		String query = "select * from Cadena where idCadena in ("
				+ "select idCadena from RelacionTipoCadenaCategoria where idRelacion in ("
				+ "select idRelacionTipoCadenaCategoria from PuntoDeVenta"
				+ " where idSubzona in " + sub +") and idTipo in " + tip + " and idCategoria in " + cat + ");";
		return query;
	}
	...
	public String generateQueryPuntos (){
		...
		String query = "select * from PuntoDeVenta where idSubzona in "
				...
				+ " where idTipo in " + tip + " and idCategoria in " + cat + ") order by idPuntoVenta";
		return query;
	}
	...
	public String getQueryDetalle(){
		...
		query.append(" and rel.idCategoria in " + cat);
